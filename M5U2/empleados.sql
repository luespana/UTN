...
SELECT nombre,apellido,trabajo FROM empleados WHERE trabajo = 'Programador' OR trabajo = 'Desarrollador Web';

/*7) Mostrar una lista (id_emp, nombre, apellido, trabajo) de las personas cuyo numero de empleado esté entre 15 y 20.*/
SELECT id, nombre, apellido, trabajo FROM empleados LIMIT 14,6;

/*8) ¿Cuáles son los Programadores que ganan menos de $80000?*/
SELECT nombre,apellido,trabajo,salario FROM empleados WHERE trabajo='Programador' AND salario < 80000;

/*9) ¿Cuáles son los Programadores que ganan entre $75000 y  $90000?*/
SELECT nombre,apellido,trabajo,salario FROM empleados WHERE trabajo = 'Programador' AND salario BETWEEN 75000 AND 90000;
